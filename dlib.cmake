...
if(WIN32)    
    ...
    if(CMAKE_SIZEOF_VOID_P EQUAL 8)      
        if(MSVC14)
            set(DLIB_LIB_PATH ${DLIB_PATH}/vc2015_64/dlib)
        endif(MSVC14)
		
        if(MSVC12)
            set(DLIB_LIB_PATH ${DLIB_PATH}/vc2013_64/dlib)
        endif(MSVC12)

        if(CMAKE_BUILD_TYPE MATCHES Release)
            set(DLIB_LIB_PATH ${DLIB_LIB_PATH}/Release)
        endif(CMAKE_BUILD_TYPE MATCHES Release)

        if(CMAKE_BUILD_TYPE MATCHES Debug)
            set(DLIB_LIB_PATH ${DLIB_LIB_PATH}/Debug)
